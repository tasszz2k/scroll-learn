...
export interface Phoneme {
  ...
  group: string;
  // Example words in which this phoneme is the dominant sound. Aim for
  // beginner-friendly, high-frequency vocabulary (typically 5 per phoneme).
  exampleWords: string[];
...
export const PHONEMES: Phoneme[] = [
  // ===== VOWELS - front =====
  {
    ...
    type: 'vowel',
    group: 'front',
    exampleWords: ['sheep', 'tree', 'feet', 'see', 'eat'],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'front',
    exampleWords: ['ship', 'bit', 'live', 'sit', 'kid'],
    minimalPairs: [['ship', 'sheep'], ['fit', 'feet'], ['bit', 'beat']],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'front',
    exampleWords: ['bed', 'red', 'head', 'ten', 'leg'],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'front',
    exampleWords: ['cat', 'bad', 'man', 'hand', 'apple'],
  ...
  // ===== VOWELS - central =====
  {
    ...
    type: 'vowel',
    group: 'central',
    exampleWords: ['cup', 'love', 'son', 'bus', 'mud'],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'central',
    exampleWords: ['about', 'sofa', 'banana', 'problem', 'lemon'],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'central',
    exampleWords: ['bird', 'word', 'her', 'nurse', 'learn'],
  ...
  // ===== VOWELS - back =====
  {
    ...
    type: 'vowel',
    group: 'back',
    exampleWords: ['food', 'blue', 'shoe', 'moon', 'true'],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'back',
    exampleWords: ['book', 'put', 'good', 'foot', 'wood'],
    minimalPairs: [['fool', 'full'], ['pool', 'pull'], ['suit', 'soot']],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'back',
    exampleWords: ['thought', 'door', 'caught', 'law', 'talk'],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'back',
    exampleWords: ['hot', 'lot', 'dog', 'box', 'stop'],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'back',
    exampleWords: ['father', 'car', 'park', 'start', 'hard'],
  ...
  // ===== DIPHTHONGS =====
  {
    ...
    type: 'vowel',
    group: 'diphthong',
    exampleWords: ['day', 'face', 'name', 'take', 'eight'],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'diphthong',
    exampleWords: ['my', 'time', 'high', 'nice', 'light'],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'diphthong',
    exampleWords: ['boy', 'coin', 'noise', 'voice', 'joy'],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'diphthong',
    exampleWords: ['now', 'house', 'cow', 'down', 'town'],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'diphthong',
    exampleWords: ['go', 'home', 'note', 'boat', 'snow'],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'diphthong',
    exampleWords: ['ear', 'here', 'beer', 'near', 'year'],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'diphthong',
    exampleWords: ['air', 'where', 'hair', 'chair', 'bear'],
    minimalPairs: [['ear', 'air'], ['here', 'hair'], ['beer', 'bear']],
  ...
  },
  {
    ...
    type: 'vowel',
    group: 'diphthong',
    exampleWords: ['tour', 'pure', 'sure', 'cure', 'jury'],
  ...
  // ===== CONSONANTS - stops =====
  {
    ...
    type: 'consonant',
    group: 'stop',
    exampleWords: ['pen', 'top', 'happy', 'park', 'paper'],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'stop',
    exampleWords: ['bad', 'baby', 'cab', 'book', 'club'],
    minimalPairs: [['pen', 'ben'], ['pat', 'bat'], ['cap', 'cab']],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'stop',
    exampleWords: ['ten', 'cat', 'water', 'table', 'time'],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'stop',
    exampleWords: ['day', 'red', 'doll', 'door', 'hand'],
    minimalPairs: [['ten', 'den'], ['cat', 'cad'], ['town', 'down']],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'stop',
    exampleWords: ['cat', 'key', 'back', 'cake', 'kick'],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'stop',
    exampleWords: ['go', 'big', 'good', 'green', 'dog'],
    minimalPairs: [['cap', 'gap'], ['back', 'bag'], ['coat', 'goat']],
  ...
  // ===== CONSONANTS - fricatives =====
  {
    ...
    type: 'consonant',
    group: 'fricative',
    exampleWords: ['fish', 'phone', 'leaf', 'face', 'friend'],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'fricative',
    exampleWords: ['van', 'love', 'live', 'voice', 'river'],
    minimalPairs: [['fan', 'van'], ['leaf', 'leave'], ['fine', 'vine']],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'fricative',
    exampleWords: ['think', 'thanks', 'math', 'three', 'both'],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'fricative',
    exampleWords: ['this', 'that', 'mother', 'they', 'brother'],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'fricative',
    exampleWords: ['sun', 'kiss', 'ice', 'six', 'mice'],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'fricative',
    exampleWords: ['zoo', 'buzz', 'rose', 'zero', 'lazy'],
    minimalPairs: [['sip', 'zip'], ['bus', 'buzz'], ['sue', 'zoo']],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'fricative',
    exampleWords: ['ship', 'fish', 'wash', 'she', 'push'],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'fricative',
    exampleWords: ['measure', 'vision', 'beige', 'treasure', 'pleasure'],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'fricative',
    exampleWords: ['hat', 'who', 'hello', 'house', 'behind'],
  ...
  // ===== CONSONANTS - affricates =====
  {
    ...
    type: 'consonant',
    group: 'affricate',
    exampleWords: ['chair', 'much', 'catch', 'cheese', 'watch'],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'affricate',
    exampleWords: ['judge', 'gym', 'edge', 'jump', 'page'],
  ...
  // ===== CONSONANTS - nasals =====
  {
    ...
    type: 'consonant',
    group: 'nasal',
    exampleWords: ['man', 'sum', 'home', 'mom', 'lemon'],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'nasal',
    exampleWords: ['now', 'sun', 'tin', 'new', 'run'],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'nasal',
    exampleWords: ['sing', 'long', 'thing', 'king', 'song'],
  ...
  // ===== CONSONANTS - approximants =====
  {
    ...
    type: 'consonant',
    group: 'approximant',
    exampleWords: ['leg', 'fall', 'love', 'look', 'milk'],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'approximant',
    exampleWords: ['red', 'right', 'very', 'run', 'road'],
    minimalPairs: [['light', 'right'], ['lead', 'read'], ['lock', 'rock']],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'approximant',
    exampleWords: ['yes', 'yellow', 'you', 'young', 'year'],
  ...
  },
  {
    ...
    type: 'consonant',
    group: 'approximant',
    exampleWords: ['win', 'water', 'away', 'work', 'way'],
